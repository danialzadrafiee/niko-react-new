// File: src/pages/admin/product/edit/_AdminProductEdit.tsx
...
const AdminProductEdit: React.FC = () => {
  ...
  const { form, handleSubmit, loading } = useProductForm(Number(id))
  ...
  return (
    <div className="">
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-lg">
        <div className="p-8">
          <h1 className="text-3xl font-bold mb-6 text-gray-800">ویرایش خدمت</h1>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <ImageUpload name="picture" existingImageUrl={getImageUrl(form.getValues("picture") as string)} form={form} />
            </div>
            <div className="border-t border-gray-200 my-6"></div>
