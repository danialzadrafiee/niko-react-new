  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-transparent bg-yellow-500 text-neutral-900 shadow hover:bg-yellow-500/80 dark:bg-yellow-700 dark:text-neutral-50 dark:hover:bg-yellow-700/80",
        primary:
          "border-transparent bg-blue-500 text-neutral-50 shadow hover:bg-blue-500/80 dark:bg-blue-700 dark:text-neutral-50 dark:hover:bg-blue-700/80",
        outline: 
          "border-neutral-200 bg-transparent text-neutral-950 hover:bg-neutral-100 dark:border-neutral-800 dark:text-neutral-50 dark:hover:bg-neutral-800",
      },
    },
    defaultVariants: {
      variant: "default",
